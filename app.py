...
color_map = pd.DataFrame([['Atlanta United','#9D2235','#A89968'],
                          ['Austin FC','#00B140','#000000'],
                          ['CF Montreal','#003DA5','#C1C6C8'],
                          ['Charlotte FC','#0085CA','#888B8D'],
                          ['Chicago Fire FC','#D50032','#141B4D'],
                          ['Colorado Rapids','#862633','#8BB8E8'],
                          ['Columbus Crew','#FEDD00','#010101'],
                          ['DC United','#E4002B','#010101'],
                          ['FC Cincinnati','#FE5000','#003087'],
                          ['FC Dallas','#BF0D3E','#00205B'],
                          ['Houston Dynamo FC','#FF6900','#101820'],
                          ['Inter Miami CF','#F5B6CD','#010101'],
                          ['LA Galaxy','#EAAA00','#13294B'],
                          ['Los Angeles FC','#101820','#C6AA76'],
                          ['Minnesota United','#8DC8E8','#010101'],
                          ['Nashville SC','#EDE939','#201547'],
                          ['New England Revolution','#0C2340','#C8102E'],
                          ['New York City FC','#9FD2FF','#000229'],
                          ['Orlando City','#5F249F','#EED484'],
                          ['Philadelphia Union','#DFD1A7','#051C2C'],
                          ['Portland Timbers','#2C5234','#C99700'],
                          ['Real Salt Lake','#9D2235','#001E62'],
                          ['Red Bull New York','#C8102E','#010101'],
                          ['San Diego FC','#687C7B','#051C2C'],
                          ['San Jose Earthquakes','#003DA5','#010101'],
                          ['Seattle Sounders FC','#2CC84D','#0032A0'],
                          ['Sporting Kansas City','#91C4EA','#002F6C'],
                          ['St. Louis City','#E0004D','#0C2340'],
                          ['Toronto FC','#A6192E','#333F48'],
                          ['Vancouver Whitecaps','#13294B','#8BB8E8'],
